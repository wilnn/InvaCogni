...
OUTPUT_DIR="model3/2TB_lam2_dc_gen_lang_img_text_no_aug30_avgtext"
RUN_NAME="2TB_lam2_dc_gen_lang_img_text_no_aug30_avgtext"
...
GENDER_DOMAIN_CLASSIFIER_FFN="[[1280, 3072], 'gelu', [3072, 512], 'gelu', [512, 1]]"
LANGUAGE_DOMAIN_CLASSIFIER_FFN="[[1280, 3072], 'gelu', [3072, 768], 'gelu', [768, 1]]"
TASK_CLASSIFIER_FFN="[[1280, 3072], 'gelu', 'dropout-0.3', [3072, 768], 'gelu', 'dropout-0.3', [768, 384], 'gelu', [384, 1]]"
CROSS_ATTENTION_FFN="[[768, 3072], 'gelu', 'dropout-0.5', [3072, 768], 'gelu']"
ATTENTION_DROPOUT=0.35
NUM_ATTENTION_HEAD=8
model_class="InvaCogni_2TB"
#--remove_punc_in_text \
