...
set REPORT_TO=wandb
set NUM_FOLD=10
set DATASET_PATH=../../datasets/taukadial/final_combined_dataset.csv
set Audio_PARENT_PATH=../../datasets/taukadial/taukadial/train/
set IMAGE_PARENT_PATH=../../datasets/taukadial/images/images/
