...
set REPORT_TO=wandb
set NUM_FOLD=10
set DATASET_PATH=./dataset/taukadial/final_combined_dataset.csv
set Audio_PARENT_PATH=./dataset/taukadial/taukadial/train/
set IMAGE_PARENT_PATH=./dataset/taukadial/images/images/
