...
OUTPUT_DIR="model/lam3_dc_gen_lang_au_text_03-5_2e-2_moreeval50"
RUN_NAME="lam3_dc_gen_lang_au_text_03-5_2e-2_moreeval50"
REPORT_TO="wandb"
NUM_FOLD=10
DATASET_PATH="../../datasets/taukadial/final_combined_dataset.csv"
Audio_PARENT_PATH="../../datasets/taukadial/taukadial/train/"
IMAGE_PARENT_PATH="../../datasets/taukadial/images/images/"
