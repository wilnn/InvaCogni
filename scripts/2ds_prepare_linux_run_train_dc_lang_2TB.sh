...
OUTPUT_DIR="model3/2ds_prepare_dc_lang_2"
RUN_NAME="2ds_prepare_dc_lang_2"
REPORT_TO="wandb"
NUM_FOLD=10
...
TASK_CLASSIFIER_FFN="[[512, 3072], 'gelu', [3072, 3072], 'gelu', [3072, 768], 'gelu', [768, 384], 'gelu', [384, 3]]"
...
accelerate launch --config_file ./accelerate_config.yaml train.py \
            --test_ds="$TEST_DS" \
            --dataset_path2="$DATASET_PATH2" \
            --audio_parent_path2="$Audio_PARENT_PATH2" \
            --dataset="$DATASET" \
            --dc_language \
            --loss_gamma=2 \
            --train_image_encoder \
